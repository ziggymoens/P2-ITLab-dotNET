    ...
    public class DataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                Sessie sessie7 = new Sessie("How fake news will ruin your career","Donald Trump komt uitleg geven over de media en hoe alles dat hem in een negatief ligt toont fake is.", date.AddDays(7), date.AddDays(7).AddHours(2).AddMinutes(0), lokaal62, lokaal62.AantalPlaatsen, Seba, academiejaar2021, "zichtbaar");
