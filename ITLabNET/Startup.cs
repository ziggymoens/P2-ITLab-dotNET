    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("Iedereen", policy => policy.RequireClaim(ClaimTypes.Role, "Hoofdverantwoordelijke", ClaimTypes.Role, "Verantwoordelijke", ClaimTypes.Role, "Gebruiker"));
                options.AddPolicy("Verantwoordelijken" , policy => policy.RequireClaim(ClaimTypes.Role, "Hoofdverantwoordelijke", ClaimTypes.Role, "Verantwoordelijke"));
            });   
